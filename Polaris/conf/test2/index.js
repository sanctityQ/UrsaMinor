...
module.exports = {
  ...
  thirft: {
    passport: {
      url: 'zk!192.168.0.211:2181,192.168.0.212:2181,192.168.0.213:2181!/rpc/test2/services/base/passport',
      options: {
        max_connections:100,
        min_connections: 10
      }
    ...
    notifaction: {
      url: 'zk!192.168.0.211:2181,192.168.0.212:2181,192.168.0.213:2181!/rpc/test2/services/base/sms',
      options: {
        max_connections:100,
        min_connections: 10
      }
    ...
    user: {
      url: 'zk!192.168.0.211:2181,192.168.0.212:2181,192.168.0.213:2181!/rpc/test2/services/p2p/user',
      options: {
        max_connections:100,
        min_connections: 10
      }
    ...
    interact: {
      url: 'zk!192.168.0.211:2181,192.168.0.212:2181,192.168.0.213:2181!/rpc/test2/services/p2p/interact',
      options: {
        max_connections:100,
        min_connections: 10
      }
    ...
    coupon: {
      url: 'zk!192.168.0.211:2181,192.168.0.212:2181,192.168.0.213:2181!/rpc/test2/services/p2p/coupon',
      options: {
        max_connections:100,
        min_connections: 10
      }
