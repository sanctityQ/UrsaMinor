...
module.exports = {
  ...
  thirft: {
    passport: {
      url: 'zk!127.0.0.1:2181,127.0.0.1:2182,127.0.0.1:2183!/rpc/services/base/passport',
      options: {
        max_connections:100,
        min_connections: 10
      }
    ...
    notifaction: {
      url: 'zk!127.0.0.1:2181,127.0.0.1:2182,127.0.0.1:2183!/rpc/services/base/sms',
      options: {
        max_connections:100,
        min_connections: 10
      }
    ...
    user: {
      url: 'zk!127.0.0.1:2181,127.0.0.1:2182,127.0.0.1:2183!/rpc/services/p2p/user',
      options: {
        max_connections:100,
        min_connections: 10
      }
    ...
    interact: {
      url: 'zk!127.0.0.1:2181,127.0.0.1:2182,127.0.0.1:2183!/rpc/services/p2p/interact',
      options: {
        max_connections:100,
        min_connections: 10
      }
    ...
    coupon: {
      url: 'zk!127.0.0.1:2181,127.0.0.1:2182,127.0.0.1:2183!/rpc/services/p2p/coupon',
      options: {
        max_connections:100,
        min_connections: 10
      }
